...
public class BackgroundTaskTests
{
    ...
    public void OnlyBuysInPast()
    {
        ...
        {
            new TradeEntry("uuid", System.DateTime.Now.AddDays(-2), "ETHCHF", 10, "ETH", "CHF", "Taker", "buy", 11, 0,
                new TradeFee(0, "CHF")),
            new TradeEntry("uuid", System.DateTime.Now.AddDays(-1), "ETHCHF", 15, "ETH", "CHF", "Taker", "buy", 12, 0,
                new TradeFee(0, "CHF")),
            new TradeEntry("uuid", System.DateTime.Now.AddDays(-2), "BTCCHF", 10, "BTC", "CHF", "Taker", "buy", 13, 0,
                new TradeFee(0, "CHF"))
        };
    ...
    public void SoldAlreadyInThePast()
    {
        List<TradeEntry> trades = new List<TradeEntry>()
        {
            new TradeEntry("uuid", System.DateTime.Now.AddDays(-4), "ETHCHF", 12, "ETH", "CHF", "Taker", "buy", 10, 0,
                new TradeFee(0, "CHF")),
            new TradeEntry("uuid", System.DateTime.Now.AddDays(-2), "ETHCHF", 2, "ETH", "CHF", "Taker", "buy", 5, 0,
                new TradeFee(0, "CHF")),
            new TradeEntry("uuid", System.DateTime.Now.AddDays(-1), "ETHCHF", 5, "ETH", "CHF", "Taker", "sell", 5, 0,
                new TradeFee(0, "CHF"))
        };
    ...
    public void SoldAlreadyMutipleTimesInThePast()
    {
        List<TradeEntry> trades = new List<TradeEntry>()
        {
            new TradeEntry("uuid", System.DateTime.Now.AddDays(-7), "ETHCHF", 8, "ETH", "CHF", "Taker", "buy", 3, 0,
                new TradeFee(0, "CHF")),
            new TradeEntry("uuid", System.DateTime.Now.AddDays(-6), "ETHCHF", 10, "ETH", "CHF", "Taker", "buy", 5, 0,
                new TradeFee(0, "CHF")),
            new TradeEntry("uuid", System.DateTime.Now.AddDays(-5), "ETHCHF", 20, "ETH", "CHF", "Taker", "buy", 8, 0,
                new TradeFee(0, "CHF")),
            new TradeEntry("uuid", System.DateTime.Now.AddDays(-4), "ETHCHF", 9, "ETH", "CHF", "Taker", "sell", 3, 0,
                new TradeFee(0, "CHF")),
            new TradeEntry("uuid", System.DateTime.Now.AddDays(-3), "ETHCHF", 11, "ETH", "CHF", "Taker", "sell", 5, 0,
                new TradeFee(0, "CHF")),
            new TradeEntry("uuid", System.DateTime.Now.AddDays(-2), "ETHCHF", 20, "ETH", "CHF", "Taker", "buy", 5, 0,
                new TradeFee(0, "CHF")),
        };
        ...
        Assert.AreEqual(13, _backgroundTask.GetMaxVolumeToSellAlwaysWin(trades, balances, assetPair, price));
    }
}